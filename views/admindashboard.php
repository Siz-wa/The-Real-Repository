...
<!-- NAKATAGO NA WALLET SECTION ONCE AGAIN DIKO ALAM ANO GAGAWIN DITO -->
                  ...
                  <div x-data="multipleTable">
                        ...
                        <div class="panel mt-6">
                            <h5 class="mb-5 text-lg font-semibold dark:text-white-light md:absolute md:top-[25px] md:mb-0">Available Courier</h5>
                ...
                Alpine.data('multipleTable', () => ({
                    ...
                    init() {
                        ...
                        this.datatable2 = new simpleDatatables.DataTable('#myTable1', {
                            data: {
                                headings: ['ID', 'Name'],
                                data:  availableCouriers.map(courier => [courier.employeeID,
                            ...
                            columns: [
                                {
                                    ...
                                    render: (data, cell, row) => {
                                        return `<a href="?action=assigndelivery&employeeID=${encodeURIComponent(data)}"><div class="flex items-center w-max">${data}</div></a>`;
                                    },
                                    sort: 'asc',
                                },
                                // {
