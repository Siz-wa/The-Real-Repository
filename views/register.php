<?php
 ...
 if(isset($_POST['submit'])){
  ...
  if(isset($_POST['fname']) && isset($_POST['lname']) && isset($_POST['email']) && isset($_POST['password']) && isset($_POST['confirm-password'])&& isset($_POST['sex'])){
    ...
    var_dump($fname, $lname, $email, $password, $confirm_password); 
...
<body class="starter-page-page">
    ...
    <main class="main d-flex justify-content-center align-items-center" style="height: 110vh; background-color:rgb(238, 238, 238);">
