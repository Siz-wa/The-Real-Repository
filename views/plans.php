                                            ...
                                            <div class="p-5">
                                                <form @submit.prevent="saveUser">
                                                    ...
                                                    <div class="mb-5">
                                                        ...
                                                        <textarea id="email" type="text" placeholder="Enter description" class="form-input" x-model="params.email"></textarea>
                                                    </div>
                                                    <div class="mb-5">
                                                        <label for="number">Price</label>
                                                        <input id="number" step="any" type="number" placeholder="Enter Phone Number" class="form-input" x-model="params.phone">
                                                    </div>
                                                    <div class="mb-5">
                            ...
                            <div class="relative overflow-hidden rounded-md bg-white text-center shadow dark:bg-[#1c232f]">
                                ...
                                <div class="relative -mt-10 px-6 pb-24">
                                    ...
                                    <div class="mt-6 grid grid-cols-1 gap-4 ltr:text-left rtl:text-right">
                                        ...
                                        <div class="flex items-center">
                                            <div class="flex-none ltr:mr-2 rtl:ml-2">Type :</div>
...
<script>
    ...
    document.addEventListener('alpine:init', () => {
        ...
        Alpine.data('contacts', () => ({
            ...
            filterdContactsList: [],
            searchUser: '',
            contactList:plansData.map((plans) => ({
                id: plans.planID,
                // path: `data:image/jpeg;base64,${employee.pfPicture}`,
                name: plans.planName,
                email: plans.description,
                phone: parseFloat(plans.price),
                location: plans.type
            })),
            ...
            const endpoint = this.params.id ?  '/API/updatePlan.php' : '/API/addPlan.php';
