...
<body x-data="main" class="relative overflow-x-hidden font-nunito text-sm font-normal antialiased" :class="[ $store.app.sidebar ? 'toggle-sidebar' : '', $store.app.theme === 'dark' || $store.app.isDarkMode ?  'dark' : '', $store.app.menu, $store.app.layout,$store.app.rtlClass]">
      ...
      <div class="main-content flex flex-col min-h-screen">
        ...
        <script>
            ...
            const genderPercentage = <?= json_encode($gendersPercentage)?>;
                ...
                Alpine.data('multipleTable', () => ({
                    ...
                    init() {
                        ...
                        this.datatable2 = new simpleDatatables.DataTable('#myTable1', {
                            data: {
                                headings: ['Genders', 'Gender Density Bar', 'Gender Density Percentage'],
                                data: genders.map((gender, index) => {
                                    return [
                                        gender,
                                        parseInt(genderPercentage[index]),
                                        genderPercentage[index] +'%',
                                    ];
                                }),
                            },
                            searchable: true,
                            ...
                            columns: [
                                {
                                    ...
                                    render: (data, cell, row) => {
                                        return `<a href="../public/index.php?action=genderdata&gender=${encodeURIComponent(data)}"><div class="flex items-center w-max">${data}</div></a>`;
                                    },
                                    sort: 'asc',
                                },
                                {
