...
class AdministratorController extends Controller{
    ...
    public function update(){
        ...
        $result = $this->administratorModel->updateEmployee($data);
    ...
    public function add(){
        ...
        $result = $this->administratorModel->addAdmin($data,$token);
    ...
    public function delete() {
        ...
        $result = $this->administratorModel->deleteEmployee($input['id']);
